...
export const filterArrayByKey = <Array1 extends Record<string, unknown>[]>(array1: Array1, array2: Record<string, unknown>[], property: keyof PickSameProperties<Array1[number], (typeof array2)[number]>): Array1 => array1.filter((item1)  => array2.some((item2) => item1[property] === item2[property])) as Array1;
export const excludeArrayByKey = <Array1 extends Record<string, unknown>[]>(array1: Array1, array2: Record<string, unknown>[], property: keyof PickSameProperties<Array1[number], (typeof array2)[number]>): Array1 => array1.filter((item1)  => !array2.some((item2) => item1[property] === item2[property])) as Array1;
