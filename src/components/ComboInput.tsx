...
export default function ComboInput({ label, className, list, value, setValue }: Props) {
  ...
  const filteredList = list.filter(item => item.label.toLowerCase().includes(inputValue.toLowerCase()));
  ...
  const handleInputChange = useCallback(
    (newValue: string) => {
      ...
      const newFilteredList = list.filter(item => item.label.toLowerCase().includes(newValue.toLowerCase()));
